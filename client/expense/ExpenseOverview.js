...
import {currentMonthPreview, expenseByCategory} from "./../expense/api-expense"
...
export default function Home() {
    ...
    return (
        <Card className={classes.card} >
            ...
            <div style={{display:"flex", justifyContent:"center", alignItems:"cente"}} >
                ...
                <div style={{margin:"20px 20px 20px 30px"}} >
                    ...
                    <Typography variant="h5" color="primary" >${expensePreview.yesterday ? expensePreview.yesterday.totalSpent : "0"}<span className={classes.day}>yesterday</span></Typography>
            ...
            <div className={classes.categorySection} >
                {expenseCategories.map((expense, index) => {
                    return(<div key={index} style={{display:"grid", justifyContent: "center"}} >
                        ...
                        <Divider className={classes.carDiv} style={{backgroundColor: indicateExpense(expense.mergedValues)}} />
                    <div>
                    ...
                    <div style={{marginBottom: 3}} >
                        ...
                        <Typography component="span" className={classes.val} style={{color: "#002f6c", fontSize:"1.16em", backgroundColor: "#eafff5", padding: "8px 0"}} >${expense.mergedValues.total ? expense.mergedValues.total : 0}</Typography>
