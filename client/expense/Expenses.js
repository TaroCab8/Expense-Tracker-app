                    ...
                    <ExpansionPanel className={classes.panel} >
                        ...
                        <ExpansionPanelDetails  style={{display:"block"}} >
                            <div>
                                ...
                                <TextField label="Amount ($)" className={classes.textField} value={expense.mount} onChange={handleChange("amount", index)} margin="normal" type="number" />
                            </div>
                            <div>
                                <MuiPickersUtilsProvider utils={DateFnsUtils} >
                                    <DateTimePicker
                            ...
                            <div className={classes.buttons}>
                                {
                                    error && (<Typography component="p" color="error" ><Icon color="error" className={classes.error} >error</Icon>{error}</Typography>)
                                }
                                {
